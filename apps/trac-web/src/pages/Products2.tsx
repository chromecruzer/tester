...
import {getProducts, postBatchExcludeUpdate} from "../api/productApi2";
...
export const Products2 = () => {
  ...
  const errorMessage = error && <div><h4 style={{color:"red"}} >Network Error</h4></div>;
  ...
  return <>
  <h2 style={{ backgroundColor: "black", textAlign: "center", color:"white" }}> For development Only</h2>
    <ChangeUnitPrice
    batchEdit={batchEdit}
