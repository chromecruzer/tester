...
import { EmployeeSignature } from "./EmployeeRecord"; // added by shyam for testing
...
export type RecordSignature = (ConsignmentSignature | CustomerSignature
  | ProductSignature | IolSignature | EmployeeSignature | UserSignature);           // marked by shyam for testing
...
export const getDataFields = {
  ...
  username: 'username',
  userpwd: 'userpwd',
  employeename: 'employeename'            // added by me shyam for testing
...
export interface SearchFilters {
  ...
  iol_reports: false,
  products: false,
  employee: false,  // added by shyam for testing
}
...
export const dataTableNames = {
  ...
  products: 'products',
  employee: 'employee',            // added by shyam for testing
...
export type DataTableNameType = (
  ...
  'salesMappings' |
  'products' |
  'employee' |          // added by shyam for testing 
  'salesJumpTable' |
  'users' 
  );
